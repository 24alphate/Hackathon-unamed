-- Unmapped core schema (SQLite) — same as /server/db/schema.sql
...
CREATE TABLE IF NOT EXISTS audit_trail (
  id INTEGER PRIMARY KEY AUTOINCREMENT,
  entity_type TEXT NOT NULL,           -- submission | job | match | badge | payment
  entity_id INTEGER,
  event_type TEXT NOT NULL,            -- evaluation_completed | badge_awarded | match_scored | etc.
